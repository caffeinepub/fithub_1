...
import type { MembershipPlan as _MembershipPlan, Ms as _Ms, PlanType as _PlanType, TrialInfo as _TrialInfo, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async activateMembership(arg0: UserId, arg1: PlanType): Promise<MembershipPlan> {
        if (this.processError) {
            try {
                const result = await this.actor.activateMembership(arg0, to_candid_PlanType_n8(this._uploadFile, this._downloadFile, arg1));
                return from_candid_MembershipPlan_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getAllMemberships(): Promise<Array<[UserId, MembershipPlan]>> {
        if (this.processError) {
            try {
    ...
    async getTrialInfo(): Promise<TrialInfo | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTrialInfo();
    ...
    async getUserAccessStatus(): Promise<UserAccessStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserAccessStatus();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_MembershipPlan_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MembershipPlan): MembershipPlan {
...
function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_TrialInfo]): TrialInfo | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        planType: from_candid_PlanType_n12(_uploadFile, _downloadFile, value.planType)
    };
}
...
function from_candid_tuple_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_UserId, _MembershipPlan]): [UserId, MembershipPlan] {
    return [
        value[0],
        from_candid_MembershipPlan_n10(_uploadFile, _downloadFile, value[1])
    ];
}
...
function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_UserId, _MembershipPlan]>): Array<[UserId, MembershipPlan]> {
